...
def load_saved_model(saved_path, model, specific_path=None, specific_epoch=None):
    """
    ...
    if specific_path is not None and specific_epoch is not None:
        model_file = specific_path
        initial_epoch = specific_epoch
    else:
...
def create_model(hypes, module_delay=False):
    """
    ...
    backbone_config['module_delay'] = module_delay
    backbone_config['freeze_heads'] = hypes['freeze_heads']
