...
__all__ = {
    ...
    'MambaMultiPredictor4D': MambaMultiPredictor4D,
    'MambaUNet': MambaUNet,
    'MambaLRU': MambaLRU,
...
def build_delay_module(delay_cfg):
    ...
    assert delay_name in ['3DCNN', 'Mamba', 'MambaMultiPredictor', 'MambaMultiPredictor4D', 'MambaUNet', 'MambaLRU'], error_message
