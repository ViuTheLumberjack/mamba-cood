...
class MambaMultiPredictorNoLin(nn.Module):
    def __init__(
        self, 
        args,
    ):
        ...
        self.hidden_dim = args.get('hidden_dim', self.input_dim)
...
class AutoregressivePredictor(MambaMultiPredictorNoLin):
...
if __name__ == '__main__':
    ...
    model = MambaMultiPredictorNoLin(args).to("cuda")
